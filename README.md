...
- Four fully synchronized, fully editable views — edit in any one of them and the others update instantly:
  ...
  - **Code** — a text editor showing the raw, formatted JSON, with live validation as you type (see [Code view](#code-view) below)
  - **Graph** — an auto-laid-out node diagram of the whole structure; tap a node to see and edit it in the details panel below the graph
...
- Download the result as a `.json` file, or copy it straight to the clipboard
- You're warned before an accidental page reload or navigation throws away an unsaved session
